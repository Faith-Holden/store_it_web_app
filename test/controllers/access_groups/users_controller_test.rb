...
class AccessGroups::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  #-----------should do actions----------------------
  test "new should render new access_group_users view" do
    flunk "test is not yet written"
  end

  test "Should create new user_access with correct info" do
    flunk "test is not yet written"
  end

  test "should not create new user_access with incorrect info" do
    flunk "test is not yet written"
  end
  ...
  test "index should show user_access" do
    flunk "test is not yet written"
  end
end